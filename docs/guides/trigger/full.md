...
!!! warning "WIP"
    This guide is still a **Work In Progress**. It is currently based off our [Quick Guide](quick.md) and will later be filled with more calculations and in-game damage comparisons to push the theorycrafting further!
...
This is Trigger's strongest team at her release. Silver Soldier Anby synergizes very well with Trigger, but this team also works with other on-field DPSes like Ellen or Evelyn.
